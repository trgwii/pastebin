...
ExecStart=/home/pastebin/.deno/bin/deno run --allow-net --allow-read=pastes --allow-write=pastes https://git.rory.no/trgwii/pastebin/raw/branch/master/serve.ts 8080 127.0.0.1
Restart=on-failure
